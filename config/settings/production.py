...
SESSION_COOKIE_SECURE = False # DJANGO SYS CHECK WARNINGS - true
...
EMAIL_SUBJECT_PREFIX = env("EMAIL_SUBJECT_PREFIX", default='[Associação de Boardgames de Teresina-PI] ')
EMAIL_USE_TLS = True
